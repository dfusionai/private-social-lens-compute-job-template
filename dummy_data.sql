...
('m001', 'c001', 'src001', 'u001', '2024-04-02 10:05:00', 'text', 'Hello! This is my first message.'),
('m002', 'c001', 'src002', 'u002', '2024-04-02 10:10:00', 'text', 'Hi there! Nice to meet you.');

-- Create the `results` table to simulate Query Engine query processing results.
CREATE TABLE results AS
SELECT * FROM submission_chats;
-- CREATE TABLE results AS
-- SELECT SenderID FROM chat_messages LIMIT 10